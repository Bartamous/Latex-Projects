...
- **Template**: Licensed under the MIT License. See `LICENSE-MIT.txt` for details.
- **Thesis Content**: Licensed under the Creative Commons Attribution-ShareAlike 4.0 International License (CC BY-SA 4.0). See `LICENSE-CC-BY-SA.txt` for details.
